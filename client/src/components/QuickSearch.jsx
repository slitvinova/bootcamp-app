...
const TYPE_COLOR = {
  test_case: 'text-indigo-600 bg-indigo-50',
        ...
        {items.map(item => {
          ...
          return (
            ...
            >
              ...
              <span className="text-sm text-gray-800 truncate flex-1">{item.title || item.name}</span>
              {item.severity && (
                <span className="text-xs text-gray-400 flex-shrink-0">{item.severity}</span>
              )}
    ...
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-[15vh]">
      ...
      <div className="relative bg-white rounded-xl shadow-2xl w-full max-w-xl mx-4 overflow-hidden">
        ...
        <div className="flex items-center gap-3 px-4 py-3 border-b border-gray-200">
          ...
          {!loading && <kbd className="text-xs text-gray-400 border border-gray-200 rounded px-1.5 py-0.5">Esc</kbd>}
        </div>
